...
document.querySelectorAll(".site-title").forEach( e => { e.innerHTML = title; });
var tagline = "a very good tag line";
document.querySelectorAll(".site-tagline").forEach( e => { e.innerHTML = tagline; });
